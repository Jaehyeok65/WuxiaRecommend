...
const Container = ( { loginstate }) => {
    ...
    return(
        <React.Fragment>
            <Community data={data} loading={loading} error={error} loginstate={loginstate} isLoginToggle={isLoginToggle}
             handleSelect={handleSelect} limit={limit} setLimit={setLimit} offset={offset} page={page} setPage={setPage}
             Selected={Selected} selectList={selectList} />
        </React.Fragment>
    )
